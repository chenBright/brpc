...
public:
    void ProcessRpcRequest(brpc::Controller* cntl,
        ...
        content_type = (brpc::ContentType)i;
        compress_type = (brpc::CompressType)j;
        ++i;
        if (i > brpc::ContentType_MAX) {
            i = brpc::ContentType_MIN;
        }
        ++j;
        if (j >= brpc::CompressType_MAX) {
            j = brpc::CompressType_MIN;
        }
...
private:
    int i = brpc::ContentType_MIN;
    int j = brpc::CompressType_MIN;
};
